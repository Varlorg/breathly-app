...
const soundEffects = {
  ...
  julianeBreatheIn: { path: "julianebreathein.mp3", sound: null as any },
  julianeBreatheOut: { path: "julianebreatheout.mp3", sound: null as any },
  julianeHold: { path: "julianehold.mp3", sound: null as any },
